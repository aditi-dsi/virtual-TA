...
AUTH_FILE = "auth.json"
OUTPUT_FILE = "../data/tds_discourse_posts.json"
...
def scrape(playwright):
    print("Starting scraping with saved session...")
    browser = playwright.chromium.launch(headless=True)
    context = browser.new_context(storage_state=AUTH_FILE)
    page = context.new_page()

    all_topics = fetch_all_topics(page)
    filtered_posts = []
    ...
    for topic in all_topics:
        ...
        accepted_answer_id = topic_data.get("accepted_answer") or topic_data.get("accepted_answer_post_id")
...
# Found 3002 total topics across all pages
# Scraped 778 posts between 2025-01-01 and 2025-04-14